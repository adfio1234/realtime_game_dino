...
class Score {
  ...
  //     if(!response.ok){
  //       throw new Error('Cant load stage.json');
  //     }
  //     const stageData=await response.json();
  //     console.log("succefully loaded stage.json!",stageData);
  //   }catch(e)
  //   {
  //     console.log('Error occured stagedata load: ',e);
  //   }
  // }
